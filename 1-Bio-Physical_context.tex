...
Moreover, the stability of a protein does not depend only by the interactions between their constituent atoms, but also with the surrounding water. For every hydrogen bond formed in a protein during folding, a hydrogen bond (of similar strength) between the same group and water was broken. Hence, the net contribution to the protein stability for the formation of a new hydrogen bond between two atoms of the protein, breaking another hydrogen bond, may be close to zero. 
