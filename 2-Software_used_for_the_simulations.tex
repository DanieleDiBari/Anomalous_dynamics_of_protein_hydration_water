...
\begin{minipage}[t]{0.725\textwidth}
	\centering
    \includegraphics[width=0.725\textwidth]{bounded_interactions.png}
...
\centering
\includegraphics[width=0.65\textwidth]{Prtoein_foldin_funnel-voet2.PNG}
...
NAMD has several important features \cite{ref:NAMD_ug}:
\begin{itemize}
