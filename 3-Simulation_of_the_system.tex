...
In the second and third section the procedure to build up the simulations of the powder systems and the measurements performed on the simulated trajectory are reported. 
...
\begin{minipage}[t]{0.7\textwidth}
	\centering
    \includegraphics[width=0.65\textwidth]{dil-1omp.jpg}
...
In the following the graph of the MSD at 220 K as a function of $t_w$ for the powder systems with the SPC/E model is presented.\footnote{Others graphs are displayed in the appendix \ref{apendix:MSD}}
\begin{figure}[H]
\centering
\begin{minipage}[t]{\textwidth}
	\centering
    \includegraphics[width=\textwidth]{./MSD/twS-spce-ll220.png}
...
\begin{minipage}[t]{0.9\textwidth}
	\centering
    \includegraphics[width=0.9\textwidth]{cluster-number.png}
...
\begin{minipage}[t]{0.9\textwidth}
	\centering
    \includegraphics[width=0.9\textwidth]{cluster-occ.png}
